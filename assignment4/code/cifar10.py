...
parser.add_argument('--data_dir', type=str, default='/home/thtran/workspace/assignment4/tmp/cifar10_data',
...
def inference(images):
  ...
  # pool1
  pool1 = tf.nn.max_pool(conv3, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1],
  ...
  # pool2
  pool2 = tf.nn.max_pool(conv6, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1],
  ...
  # pool3
  pool3 = tf.nn.max_pool(conv9, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1],
                         padding='SAME', name='pool3')
					
  # local3
  with tf.variable_scope('local1024') as scope:
